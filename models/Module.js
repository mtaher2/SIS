...
class Module {
        ...
        try {
            ...
            if (error.code === 'ECONNRESET' || error.code === 'PROTOCOL_CONNECTION_LOST') {
                try {
                    ...
                    console.error('Error on retry finding modules by course:', retryError);
                    throw retryError;
                }
            }
    ...
    static async create(moduleData) {
        try {
            ...
            const position = positionResult[0].maxPosition !== null 
        ...
        try {
            ...
            if (error.code === 'ECONNRESET' || error.code === 'PROTOCOL_CONNECTION_LOST') {
                try {
                    ...
                    console.error('Error on retry updating module positions:', retryError);
                    throw retryError;
                }
            }
