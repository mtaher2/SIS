...
router.post(
  "/courses/:id/modules/:moduleId/toggle-publish",
  moduleController.toggleModulePublish,
);
...
router.get(
  "/modules/:moduleId/pages/:pageId/edit",
  moduleController.getEditPage,
);
router.put(
...
router.post(
  "/modules/:moduleId/pages/:pageId/toggle-publish",
  moduleController.togglePagePublish,
);
...
router.get(
  "/modules/:moduleId/quizzes/:quizId/edit",
  moduleController.getEditQuiz,
);
router.put(
...
router.delete(
  "/modules/:moduleId/quizzes/:quizId",
  moduleController.deleteQuiz,
);
router.post(
  "/modules/:moduleId/quizzes/:quizId/toggle-publish",
  moduleController.toggleQuizPublish,
);
router.get(
  "/modules/:moduleId/quizzes/:quizId/questions",
  moduleController.getQuizQuestions,
);
router.get(
  "/modules/:moduleId/quizzes/:quizId/questions/data",
  moduleController.getQuizQuestionsData,
);
router.post(
  "/modules/:moduleId/quizzes/:quizId/questions",
  moduleController.createQuizQuestion,
);
router.put(
  "/modules/:moduleId/quizzes/:quizId/questions/:questionId",
  moduleController.updateQuizQuestion,
);
router.delete(
  "/modules/:moduleId/quizzes/:quizId/questions/:questionId",
  moduleController.deleteQuizQuestion,
);

// Enhanced assignment management
router.get("/modules/:moduleId/assignments", moduleController.getAssignments);
router.get(
  "/modules/:moduleId/assignments/create",
  moduleController.getCreateAssignment,
);
router.post(
...
router.get(
  ...
  moduleController.getAssignment,
);
router.get(
  "/modules/:moduleId/assignments/:assignmentId/edit",
  moduleController.getEditAssignment,
);
router.put(
  "/modules/:moduleId/assignments/:assignmentId",
  [check("title", "Title is required").notEmpty()],
...
router.delete(
  "/modules/:moduleId/assignments/:assignmentId",
  moduleController.deleteAssignment,
);
router.post(
  "/modules/:moduleId/assignments/:assignmentId/toggle-publish",
  moduleController.toggleAssignmentPublish,
);
router.get(
  "/modules/:moduleId/assignments/:assignmentId/submissions",
  moduleController.getSubmissions,
);
router.get(
  "/modules/:moduleId/assignments/:assignmentId/submissions/:submissionId",
  moduleController.getSubmission,
);
router.post(
  "/modules/:moduleId/assignments/:assignmentId/submissions/:submissionId/grade",
  moduleController.gradeSubmission,
);

// Course material management (legacy)
router.get("/courses/:id/add-material", instructorController.getAddMaterial);
router.post(
  "/courses/:id/add-material",
  upload.single("file"),
  [
    check("title", "Title is required").notEmpty(),
...
router.post(
  "/courses/:id/materials/:materialId/delete",
  instructorController.deleteMaterial,
);
...
router.post(
  "/courses/:id/students/:studentId/remove",
  instructorController.removeStudentFromCourse,
);

// Assignment management (legacy)
router.get(
  "/courses/:id/add-assignment",
  instructorController.getAddAssignment,
);
router.post(
  "/courses/:id/add-assignment",
  [
    ...
    check(
      "weight_percentage",
      "Weight percentage must be a valid number",
    ).isNumeric(),
  ],
...
router.get(
  ...
  instructorController.getGradeAssignment,
);
router.post(
  "/courses/:courseId/assignments/:assignmentId/grade",
  instructorController.postGradeAssignment,
);
...
router.post(
  ...
  instructorController.updateGradeWeights,
);
router.put(
  "/courses/:courseId/grades/:studentId",
  instructorController.updateStudentGrade,
);
